  ...
  return (
    <ScreenWrapper className="bg-white">
      ...
      <div className="bg-white px-6 py-4 border-b border-gray-200 flex items-center">
        ...
        <h1 className="text-lg font-semibold text-[#1A1A1A]">Step 3 of 5</h1>
      </div>
      
      {/* Progress Bar */}
      <div className="px-6 py-4 bg-gray-50">
        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
          <div className="h-full bg-[#00C57E] rounded-full" style={{ width: '60%' }}></div>
        </div>
      </div>
      ...
      <div className="flex-1 p-6 space-y-6 overflow-y-auto">
        <div>
          <h2 className="text-2xl font-bold text-[#1A1A1A] mb-2">Drop-off Location</h2>
          <p className="text-sm text-[#666666]">Where should it be delivered?</p>
        </div>
